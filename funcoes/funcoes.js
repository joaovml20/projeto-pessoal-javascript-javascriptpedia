...
// outro exemplo de função, dessa vez ela retorna um valor a uma variavel, lembre-se que a palavra-chave return fara que a função ira retorna o valor a direita dela quando chamada, nesse caso, resultado
// note tambem que as variaveis dentro da funcão divisao é diferente das variaveis da função multiplicacao que esta acima, pos apesar da assimilaridade do nome, elas tem escopo diferentes
...
let numero3 = 10
let numero4 = 5
let resultado = divisao(numero3,numero4) // numero1 e numero2 dentro da função divisao iram receber os valores da variavel numero3 e numero4 respectivamente, a função divisao ira trabalhar com esses valores e ira retorna o resultado para a variavel resultado
